    ...
    <div className='min-h-screen bg-gray-100 flex items-center justify-center px-4'>
      <div className='w-full max-w-md rounded-2xl bg-white shadow-xl p-8'>
        ...
        <div className='flex flex-col items-center mb-6'>
          <div className='flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#C9A86A] to-[#E7C9A9] text-white font-bold'>
            N
          </div>
          <h1 className='text-xl font-semibold text-gray-900'>Nora Photobooth</h1>
